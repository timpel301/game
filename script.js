window.addEventListener('load', function(){
    ...
    class Player {
        ...
        update(){
            ...
            if (distance > this.speedModyfier){
            ...
            this.collisionX += this.speedX * this.speedModyfier;
            this.collisionY += this.speedY * this.speedModyfier;
        }
    }
    ...
    class Game {
        constructor(canvas){
            ...
            //event listeners with ES6 arrow function to inherit from class
    ...
    function animate(){
        ...
        game.render(ctx);
        window.requestAnimationFrame(animate); //endless animation loop
    }
    animate();
